...
static const char *error_string_array[] = {
	...
	[ ERROR_INDEX(LTTNG_ERR_ROTATION_PENDING) ] = "Rotate already pending for this session.",
	[ ERROR_INDEX(LTTNG_ERR_ROTATION_NOT_AVAILABLE) ] = "Rotate feature not available for this type of session",
	[ ERROR_INDEX(LTTNG_ERR_ROTATION_TIMER_IS_SET) ] = "Rotate timer already setup for this session",
	[ ERROR_INDEX(LTTNG_ERR_ROTATION_SIZE_IS_SET) ] = "Rotate size already setup for this session",
	[ ERROR_INDEX(LTTNG_ERR_ROTATION_MULTIPLE_AFTER_STOP) ] = "Already rotated once after a stop",
	[ ERROR_INDEX(LTTNG_ERR_ROTATION_WRONG_VERSION) ] = "Rotate not supported by this kernel tracer version",
	[ ERROR_INDEX(LTTNG_ERR_ROTATION_MANUAL_UNSUPPORTED) ] = "Manual rotation unsupported when size or timer-based rotations are enabled",

	[ ERROR_INDEX(LTTNG_ERR_ROTATION_NOT_AVAILABLE_RELAY) ] = "Rotate feature not available on the relay.",
	/* Last element */
